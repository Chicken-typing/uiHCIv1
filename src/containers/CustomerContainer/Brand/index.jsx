...
function Brand() {
  ...
  return (
    <div>
      ...
      <h2 className="mt-[20px] text-2xl font-bold tracking-tight text-gray-700 text-center">
        Our Brand
      </h2>
      <div
        className="lg:flex justify-evenly mt-[20px] lg:p-[25px]  m-md:flex m-md:flex-col m-md:justify-center m-md:items-center "
        id="main-title"
      >
